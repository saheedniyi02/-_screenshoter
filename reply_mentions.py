...
def reply_mentions():
    ...
    #reply="Your screenshot can be found below 😁!\n\n🤩Ad: This Crypto project #Safcoin has grown by 500% despite the bear and red market making lots of people money Join there Group to See why: https://t.me/SafcoinGroup "
    #reply=random.choice([reply_1,reply_2])
